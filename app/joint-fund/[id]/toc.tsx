...
export function Toc() {
  ...
  return (
    <div className="sticky top-0 md:top-10 left-0 bg-incubation md:bg-active text-white p-4 md:p-10 md:border md:border-main h-max flex flex-col">
        ...
        {TOC_ITEMS.map((item) => (
          <Link
            ...
            className={cn(
              ...
              activeId === item.id ? "text-main border-main" : "text-white hover:text-main hover:border-main"
            )}
          >

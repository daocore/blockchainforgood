...
export const Intro = () => {
  return (
    <div
      id="about"
      className="flex-col justify-start items-center gap-8 md:gap-4 flex md:w-content flex-wrap px-4 md:px-0 text-center md:text-left"
    >
      <div className="justify-center md:justify-between items-center inline-flex flex-wrap border">
        <div className="w-full md:w-[499px] flex-col md:justify-start items-start gap-2 inline-flex md:mt-0 mt-4">
          <div className="self-stretch justify-center items-center gap-2.5 inline-flex">
            <h3 className="grow shrink basis-0 text-black text-[32px] font-bold font-['Inter'] leading-[41.60px]">
              Force for Good
            </h3>
          </div>
          <div className="self-stretch justify-center items-center gap-2.5 inline-flex">
            <p className="grow shrink basis-0 text-[#576172] text-base font-normal font-['Inter'] leading-normal">
              Join our mission to leverage blockchain for global good through
        ...
        <div className="justify-start items-start flex w-full gap-4 xs:gap-0 md:w-1/2 flex-wrap">
          {forces?.map((force, index) => {
            return (
              <div
                key={index}
                className="flex-col justify-center md:justify-start items-start gap-2 inline-flex w-full xs:w-1/3 px-2"
              >
                <Image
                  alt=""
                  className="w-40 h-[97.88px] m-auto"
                  src={force?.img}
                />
      ...
      <div className="w-full justify-start items-center md:gap-[214px] inline-flex flex-wrap mt-8 xs:mt-10 md:mt-0">
        <Image
          alt=""
          className="w-[208px] md:w-[410px] m-auto md:m-0"
          src={WhatBag}
        />
          ...
          <div className="self-stretch md:h-[228px] flex-col justify-start items-start gap-4 md:gap-3 flex">
            {wahts?.map((what, index) => {
              return (
                <div
                  key={index}
                  className="self-stretch md:h-[72px] flex-col justify-start items-start flex"
                >
                  <div className="self-stretch justify-center items-center gap-2.5 inline-flex">
                    <h4 className="grow shrink basis-0 text-black text-base font-bold font-['Inter'] leading-normal">
                      {what?.title}
                  ...
                  <div className="self-stretch justify-center items-center gap-2.5 inline-flex">
                    <p className="grow shrink basis-0 text-[#576172] text-[15px] font-normal font-['Inter'] leading-normal">
                      {what?.desc}
                    </p>
                  </div>
                </div>
      ...
      <div className="w-full md:h-[364px] flex flex-col-reverse md:flex-col justify-center md:justify-between flex-wrap">
        <div className="w-full md:w-[499px] md:h-[298px] flex-col justify-start items-start gap-2 inline-flex">
          <div className="self-stretch h-[42px] flex-col justify-start items-start flex">
            <div className="self-stretch justify-center items-center gap-2.5 inline-flex">
              <div className="grow shrink basis-0 text-black text-[32px] font-bold font-['Inter'] leading-[41.60px]">
                How you can help
              </div>
            </div>
          </div>
        ...
        <Image
          alt=""
          className="w-[330px] md:w-[604px] m-auto"
          src={HowCanHelp}
        />
      </div>
    </div>

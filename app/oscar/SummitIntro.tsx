...
export const OscarTitle = ({ text, center }: { text: string, center?: boolean }) => {
  const mobile = useIsMobile();

  return <h2 className={`font-bold text-oscarActive font-['Inter'] text-[20px] md:text-[32px] ${center ? "text-center md:text-left" : "text-left"}`} style={{
...
export const SummitInto = () => {
  ...
  return (
    <div className="w-full md:w-content m-auto px-6 md:px-0">
      <OscarTitle text="Sustainable Innovation Summit: The 17 SDG Challenge" center/>

...
export const Footer = () => {
    return (
        <div className="w-full h-[197px] bg-zinc-300 flex justify-center items-center mt-4" >
            <div className="w-full md:w-content h-[196.91px] py-8 flex-col justify-start items-start gap-8 inline-flex">
                <div className="flex-col justify-start items-start gap-4 flex w-full">
                    ...
                    <div className="justify-center items-center gap-2 inline-flex m-auto md:m-0 cursor-pointer" onClick={() => {

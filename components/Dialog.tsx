    ...
    <Transition.Root show={open} as={Fragment}>
      ...
      >
        ...
        <div
          ...
          style={{ width: mobile ? "100%" : width || 680, margin: "auto" }}
        >
...
export const DialogsWithFooterAndTitle = ({
  open,
  setOpen,
  children,
  title,
  ...
  return (
    <Dialogs open={open} width={width}>
      <div
        className="bg-transparent dark:bg-[#1a1b1f] p-4 sm:p-6 sm:pb-4"
        style={css}
      >
        <div className="flex items-center justify-between">
          {title ? (
            <h1 className="font-black text-2xl font-Poppins-bold pb-4 text-textColor dark:text-[rgba(225,225,225)]">
              {title}
            </h1>
          ) : (
            <div className="h-6" />
          ...
          {setOpen && (
            <div
              className="cursor-pointer mb-4 md:-mr-6 mr-0"
              onClick={() => {
                if (close) {
                  close();
                  return;
  ...
  return (
    ...
    >
      <rect
        ...
        height="1.60573"
        rx="0.802867"
        transform="rotate(45 5.75586 4.62012)"
        fill="#ffffff"
      />
      <rect
        x="4.61914"
        ...
        height="1.60573"
        rx="0.802867"
        transform="rotate(-45 4.61914 18.2451)"
        fill="#ffffff"
      />
    </svg>
  );
